...
def main():
    ...
    ap.add_argument("--z-drop", type=float, default=2.5, help="Vertex drop z-score threshold vs shoulders.")
    ap.add_argument("--slope-sigma", type=float, default=1.0, help="Slope threshold factor (sigma_shoulder / w).")
    ap.add_argument("--q3-sigmas", type=float, default=1.0, help="Q3 inside must be within this many sigmas of baseline.")
    ap.add_argument("--local-rect-occ", type=float, default=0.85, help="Inside-interval vertical occupancy threshold to reject lower-rectangle.")
